...
describe('ProgressbarComponent', () => {
    ...
    it('should handle input striped', () => {
        ...
        fixture.detectChanges();
        expect(component.progressBarClasses.find(c => c === 'progress-bar-striped')).toBeDefined();
    });
    it('should handle input animated', () => {
        hostComponent.animated = true;
        fixture.detectChanges();
        expect(component.progressBarClasses.find(c => c === 'progress-bar-animated')).toBeDefined();
    });
});
